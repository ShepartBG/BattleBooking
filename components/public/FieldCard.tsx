    ...
    <article className="group overflow-hidden rounded-[2rem] border border-white/10 bg-black/60 backdrop-blur-xl transition duration-300 hover:-translate-y-1 hover:border-[#95c900]/45 hover:shadow-[0_0_55px_rgba(149,201,0,0.14)]">
      ...
      <div className="relative p-5 pt-0">
        <div className="-mt-12 flex justify-center">
          <div className="rounded-full border border-[#95c900]/30 bg-black/80 p-1 shadow-[0_0_35px_rgba(0,0,0,.6)]">
            <FieldLogoFrame
              src={logo}
              alt={name}
              size="lg"
        ...
        <div className="mt-4 text-center">
          ...
          <h3 className="mx-auto mt-2 max-w-[18rem] text-2xl font-black leading-tight text-white">
            {name}
          </h3>
        </div>
